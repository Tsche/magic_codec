...
# @generated by pegen from src/magic_codec/parser/peg.peg
...
class PegParser(Parser, ):
    ...
    KEYWORDS = ()
    SOFT_KEYWORDS = ('memo',)
    RULES = ('start', 'grammar', 'metas', 'meta', 'rules', 'rule', 'rulename', 'memoflag', 'alts', 'more_alts', 'alt', 'items', 'named_item', 'forced_atom', 'lookahead', 'item', 'atom', 'action', 'annotation', 'target_atoms', 'target_atom', 'target_fstring_middle')


if __name__ == '__main__':
    from pegen.parser import simple_parser_main
    simple_parser_main(PegParser)
